...
namespace Pulumi.Aviatrix
{
    public static class GetAviatrixNetworkDomains
    {
        public static Task<GetAviatrixNetworkDomainsResult> InvokeAsync(InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAviatrixNetworkDomainsResult>("aviatrix:index/getAviatrixNetworkDomains:getAviatrixNetworkDomains", InvokeArgs.Empty, options.WithDefaults());
    }
