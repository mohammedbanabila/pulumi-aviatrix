...
before:
  ...
  - make tfgen
builds:
- binary: pulumi-resource-aviatrix
  dir: provider
  goarch:
  - amd64
  - arm64
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-aviatrix/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-aviatrix/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-aviatrix_darwin_amd64_v1
│   └── pulumi-resource-aviatrix
├── pulumi-aviatrix_darwin_arm64
│   └── pulumi-resource-aviatrix
├── pulumi-aviatrix_linux_amd64_v1
│   └── pulumi-resource-aviatrix
├── pulumi-aviatrix_linux_arm64
│   └── pulumi-resource-aviatrix
├── pulumi-aviatrix_windows_amd64_v1
│   └── pulumi-resource-aviatrix.exe
└── pulumi-aviatrix_windows_arm64
    └── pulumi-resource-aviatrix.exe
```
