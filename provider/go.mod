module github.com/astipkovits/pulumi-aviatrix/provider
...
//replace github.com/AviatrixSystems/terraform-provider-aviatrix/v2 v2.24.1 => /home/ubuntu/terraform-provider-aviatrix

//replace github.com/pulumi/pulumi-terraform-bridge/v3 v3.33.0 => /home/ubuntu/pulumi-terraform-bridge

require (
	github.com/AviatrixSystems/terraform-provider-aviatrix/v2 v2.24.1
